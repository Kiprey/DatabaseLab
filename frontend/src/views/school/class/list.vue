  ...
  <div class="app-container">
    <el-form :model="queryData" ref="queryForm" :inline="true">
      ...
      <el-form-item>
        ...
        <router-link :to="{path:'/school/class/edit'}" class="link-left">
    ...
    <el-table v-loading="listLoading" :data="tableData" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="270px" label="操作" align="center">
        <template slot-scope="{row}">
          <router-link :to="{path:'/school/class/edit', query:{classCode:row.classCode}}" class="link-left">
  ...
  methods: {
    ...
    deleteClass (row) {
      ...
      this.$confirm('确定删除 ?', '提示', {
        ...
        API.deleteClass(row.classCode).then(re => {
          if (re.code === '0') {
            _this.search()
